  ...
  "inline-flex items-center rounded-full border px-3 py-1 text-xs font-semibold transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 shadow-sm",
  {
    variants: {
      variant: {
        ...
        success:
          "border-transparent bg-success text-white hover:bg-success/90 hover:shadow-md",
        warning:
          "border-transparent bg-warning text-white hover:bg-warning/90 hover:shadow-md",
        info:
          "border-transparent bg-info text-white hover:bg-info/90 hover:shadow-md",
