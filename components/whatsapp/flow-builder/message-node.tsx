...
export const MessageNode = memo((props: NodeProps) => {
    ...
    return (
        <div className="relative">
            <Card className={`w-64 border-white/10 bg-[#1a1a2e]/80 backdrop-blur-xl overflow-visible transition-all ${selected ? 'ring-2 ring-primary shadow-[0_0_20px_rgba(168,85,247,0.3)]' : ''}`}>
